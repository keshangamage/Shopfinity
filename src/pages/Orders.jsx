                  ...
                  <div className="flex flex-col items-start md:items-end">
                    ...
                    <div className="flex space-x-2">
                      <button
                        ...
                        className="inline-flex items-center px-4 py-2 bg-teal-500 bg-opacity-10 hover:bg-opacity-20 text-teal-800 rounded-full text-sm font-medium transition-colors"
                      >
                        View Details{" "}
                      ...
                      {order.status === "Processing" && (
                        <button
                          ...
                          className="inline-flex items-center px-4 py-2 bg-red-500 bg-opacity-10 hover:bg-opacity-20 text-red-800 rounded-full text-sm font-medium transition-colors"
                        >
      ...
      <div className="mt-10 bg-blue-50 border border-blue-200 rounded-xl p-6 flex items-start">
        ...
        <div>
          ...
          <p className="text-gray-600 mt-1">
            If you have any questions about your orders or need assistance with
            returns, our customer support team is available 24/7.
          </p>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl shadow-lg p-6 max-w-md w-full animate-fade-in">
            ...
            <p className="text-gray-600 mb-6">
              ...
              <span className="font-medium">{orderToCancel?.id}</span>? This
